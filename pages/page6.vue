...
export default defineComponent({
  ...
  setup() {
    ...
    const texts = ref([
      'Ao chegar à sexta ilha, os tempos melhoraram, mas Esther ainda sentia a sombra da dúvida, incapaz de ver como poderia alcançar novos objetivos e desafios.',
      'Em meio a essa incerteza, ela se tornou pensativa e reflexiva. Mas então, em um momento de quietude, as estrelas se alinharam com seus princípios e propósitos, e seus pensamentos se iluminaram.',
      'Com a mente clara e o coração mais leve, Esther encontrou a força para seguir em frente e encarar o próximo desafio que a esperava.'
    ]);
    ...
    const goToNextPage = () => {
      router.push('/page7'); // Redireciona para a próxima página (page2)
    };
