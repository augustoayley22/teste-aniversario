...
export default defineComponent({
  ...
  setup() {
    ...
    const texts = ref([
      'Ao chegar nessa nova ilha, Esther sentiu o peso do cansaço, fruto dos desafios enfrentados em sua jornada. Um dia, enquanto navegava, o céu se fechou, e o mar, antes calmo, tornou-se traiçoeiro.',
      'Correntes violentas surgiram de repente, arrastando seu barco até que ele finalmente naufragou.',
      'Envolta pela escuridão e pela fúria das águas, sua visão se apagou. Mas, no auge do desespero, alguém a alcançou e a puxou para a superfície, conduzindo-a à próxima ilha, onde novos caminhos a esperavam.',
    ]);
    ...
    const goToNextPage = () => {
      router.push('/page4'); // Redireciona para a próxima página (page2)
    };
