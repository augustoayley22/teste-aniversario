...
export default defineComponent({
  ...
  setup() {
    ...
    const texts = ref([
      'Na sua segunda ilha, Esther encontrou um grupo de pessoas peculiares, movidos pelo mesmo desejo de aprender e adquirir novos conhecimentos.',
      'Assim, assim seguiu nesse caminho para novas descobertas, e de trabalho e encontrar algo que realmente goste de fazer. Ao longo do caminho, fez novos amigos e enfrentou desafios inesperados.',
      'Ah, Esther, sempre atraída pelo que é mais difícil, pelo que testa os limites.',
      'Com novos desafios vencidos, decidiu que era hora de partir para outra ilha, em busca do que ainda não conhecia.',
    ]);
    ...
    const goToNextPage = () => {
      router.push('/page3'); // Redireciona para a próxima página (page2)
    };
