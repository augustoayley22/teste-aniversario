...
export default defineComponent({
  ...
  setup() {
    ...
    const texts = ref([
      'Ao alcançar a nova ilha, tudo parecia calmo, com novos objetivos e desafios cuidadosamente planejados. Esther sentia a tranquilidade de um tempo promissor.',
      'No entanto, uma doença avassaladora a atingiu, tornando-a incapaz de seguir adiante, impedindo-a de realizar seus sonhos e enfrentar seus desafios.',
      'Em meio a essa fragilidade, ela começou a duvidar de si mesma, mergulhando cada vez mais em seus pensamentos, sentindo-se perdida.',
      'Mas, em um momento inesperado, uma nova rota se revelou diante dela.',
      'Com a esperança renovada, Esther decidiu seguir por esse novo caminho, determinada a sair daquela escuridão e reencontrar seu propósito.',
    ]);
    ...
    const goToNextPage = () => {
      router.push('/page6'); // Redireciona para a próxima página (page2)
    };
